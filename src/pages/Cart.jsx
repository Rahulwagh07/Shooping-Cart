...
const Cart = () => {
    ...
    <div  >
  {
    ...
    (<div className="max-w-[1200px] mx-auto flex flex-col md:flex-row justify-center">
      ...
      <div className="w-[100%] md:w-[40%] mt-5 flex flex-col">
        ...
        <div className="flex flex-col gap-5" >
          ...
          <div className="font-semibold text-4xl text-green-700 -mt-5">SUMMARY</div>
          <p className="text-xl">
        ...
        <div className="flex flex-col">
          ...
          font-bold hover:text-green-700 p-3 text-xl ">
            CheckOut Now
          </button>
        </div>
    ...
    (<div className="flex flex-col justify-center items-center min-h-[80vh]">
      <h1 className="font-semibold text-grey-700 text-xl mb-2">Your cart is empty!</h1>
      <Link to={"/"}>
        <button className="bg-green-700 hover:bg-purple-50 rounded-lg text-white 
          transition duration-300 ease-linear mt-5 border-2 border-green-600 
          font-bold hover:text-green-700 p-3 text-xl ">
